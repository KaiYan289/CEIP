...
hps_model = {
    "seed":0,
    "num_flow_layers":4,
    "task_specific_layers":[True, True, True, True],
    "flips": [True, True, True, True],
    "extractor_output_size":256, 
    "flow_middle_size":32,
    "image_input":False,
    "type":None,  
    "rot_pattern": np.array([[0, 1, 2, 3], [2, 3, 0, 1], [2, 0, 3, 1], [2, 3, 0, 1]]) # np.array([[2, 1, 0, 3], [3, 0, 2, 1], [1, 0, 3, 2], [1, 2, 0, 3]]) # [None, None, None, None]  # old version: np.array([[0, 1, 2, 3], [2, 3, 0, 1], [1, 0, 3, 2], [3, 2, 1, 0]]) # todo: change this dead code.
}
"""
hps_model = {
    "flow_middle_size":32
...
def get_args():
    ...
    parser.add_argument('--env_name', default="bipedalwalker", help="environment name") # deprecated
    parser.add_argument('--train', default=1, type=int,help="train or not. 0 no 1 yes.") 
    parser.add_argument('--train_size', default=1600, type=int,help="train size.") # 1600 for ours; 160 for PARROT
    parser.add_argument('--transfer_size', default=160, type=int,help="transfer size.") # 160 for ours
    parser.add_argument('--first_steps', default=40, type=int, help="first steps.") # deprecated
    parser.add_argument('--direction', default=4.5, type=float, help="direction")  # 
