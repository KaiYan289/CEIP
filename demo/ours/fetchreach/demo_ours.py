...
if __name__ == "__main__":
    ...
    wandb.login(key=XXXXXXX) # FILL IN HERE!
    wandb.init(entity=XXXXXXX, project="integration", name="ours_"+str(args.seed))
    # code backup
    ...
    hps_train_setter("current_method", "ours")
