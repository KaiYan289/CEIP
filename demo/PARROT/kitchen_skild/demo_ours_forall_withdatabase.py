...
real_names = ["oneshot-2", "oneshot-1", "TA_only"]#["task-specific2-sub", "task-specific-sub"]#["microwave_kettle_hinge_slide"]
...
if __name__ == "__main__":
    ...
    wandb.init(entity=XXXXXXX, project="integration_2", name="PARROT_decoupled_"+str(args.seed))
    ...
    hps_train_setter("current_method", "PARROT_ours_decoupled")
